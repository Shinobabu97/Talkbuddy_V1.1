      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
          {mockStats.map((stat, index) => {
            ...
            return (
              <div key={index} className="card-glass-dark no-hover rounded-xl p-4 lg:p-6 shadow-glass">
        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="card-glass-dark no-hover rounded-xl p-4 lg:p-6 shadow-glass mb-6">
              <h2 className="text-xl font-semibold mb-4 text-glass-dark">
                Quick Start
              </h2>
              <div className="grid sm:grid-cols-2 gap-4">
                <button className="p-4 glass-dark-subtle actionable rounded-lg transition-all duration-300 text-left shadow-glass">
            ...
            {/* Recent Topics */}
            <div className="card-glass-dark no-hover rounded-xl p-4 lg:p-6 shadow-glass">
              <h2 className="text-xl font-semibold mb-4 text-glass-dark">
                Recent Topics
              </h2>
              <div className="space-y-3">
                {recentTopics.map((topic, index) => (
                  <div key={index} className="flex items-center justify-between p-3 glass-dark-subtle rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs sm:text-sm text-gray-700-dark">{topic.duration}</div>
                      </div>
                    </div>
          ...
          <div className="space-y-6">
            ...
            {/* Next Session */}
            <div className="btn-glossy rounded-xl p-4 lg:p-6 text-white shadow-glass-lg">
