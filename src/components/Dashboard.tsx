        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-white/90">Hi, {firstName}!</span>
              <button
                onClick={handleLogout}
                className="flex items-center space-x-2 px-4 py-2 glass-button rounded-lg transition-colors text-white"
              >
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {mockStats.map((stat, index) => {
            ...
            return (
              <div key={index} className="glossy-card rounded-xl p-6 shadow-lg">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="glossy-card rounded-xl p-6 shadow-lg mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="glossy-card rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-800 text-sm">First Week</div>
                    <div className="text-xs text-slate-600">Completed 7 conversations</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-800 text-sm">Consistent Learner</div>
            ...
            {/* Next Session */}
            <div className="btn-professional rounded-xl p-6 text-white">
